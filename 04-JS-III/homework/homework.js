...
let mayor = arreglo.filter(element => element > 18);
...
function empiezaConNueve(n) {
  ...
  let numero = n.toString() // es to.String significa que a n me lo convierta en un string
if(numero[0] === '9' ){
  return true;
}else{
  return false;
...
function mayorACien(array) {
  ...
  //array=[5,145,15,1,52,51,5,315,14,532,534,1,6]
